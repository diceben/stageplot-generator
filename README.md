...
- **Schnell zuordnen:** Suche nach Signal, Kanalnummer, Mikrofon oder Stagebox sowie Filter „Ohne Nummer“ und „Ohne Zuordnung“. Direkt an der Signalzeile öffnet „Stagebox verbinden“ ein kompaktes Fenster mit Stagebox-Bildern, sichtbaren XLR-/Kombibuchsen und einem Vorschlag für freie Anschlüsse. Buchsen direkt anklicken; der aktive Input/Output glitzert rosa, bei Stereo gemeinsam mit L/R. Belegte Buchsen zeigen den Signalnamen. Auch im Signal-Editor ersetzen sichtbare Buchsen die bisherigen Zahlenfelder. Die vollständige Stagebox-Belegung bleibt eine eigene Übersicht. Stereo wird gemeinsam zugeordnet; vorhandene Kanalnummern und Ports bleiben beim automatischen Ergänzen erhalten. Rückgängig/Wiederholen ist in allen Audio-Ansichten erreichbar.
