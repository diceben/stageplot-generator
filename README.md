...
- **Klare Arbeitsbereiche:** Projekte, Bühnenplan, Kanäle & Routing, Projektdaten sowie Export & Teilen. Projektdaten zeigen die tatsächliche Bühnenfläche und bei freien Grundrissen die Gesamtausdehnung inklusive Anbauten; „Bühnenform bearbeiten“ führt direkt zum Grundriss.
- **Mehr Platz auf kleinen Bildschirmen:** kompakte Beta-Information und eine gemeinsam scrollende Projektübersicht. „Projekt hinzufügen“ bleibt die erste Karte. Im Editor öffnen beschriftete Schaltflächen die Bausteine und die ausgewählten Objekteigenschaften; die leere rechte Seitenleiste klappt am Desktop automatisch ein.
- **Export nach Zweck:** „Bühnenplan als Bild“, „Technische Infos für Veranstalter“ und „Ansichtslink teilen“ bieten passende Voreinstellungen. Bildvorschau und PNG werden passend zugeschnitten; das Veranstalter-PDF enthält standardmäßig Projektdaten, Technik, Legende, Notizen und Kanallisten. Details bleiben anpassbar; PDF-Seitenumbrüche entstehen beim Drucken. Freigabelinks enthalten eine schreibgeschützte Momentaufnahme, spätere Änderungen benötigen einen neuen Link. Projektkopien und Veranstalter-PDF stehen mit der kostenlosen Pro-Beta bereit.
