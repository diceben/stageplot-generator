...
- **Gerenderte Technik-Draufsichten:** 21 neue monochrome, realistische Bild-Assets für Laptop, Rack, Mischpulte, Stageboxen, Wedge, Teleprompter, Verstärker, FOH und Zubehör. Gemeinsame Darstellung in Bibliothek, Bühne, Projektvorschau und Export bei unveränderten Gerätemaßen. [Assets und Herkunft](stageplot-assets/tech/manifest.json), [Prompts](stageplot-assets/tech/prompts.json).
