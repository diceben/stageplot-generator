...
- **Übersichtlicher Export:** Direkte Auswahl zwischen PDF, Bild und Link. PDF bietet „Nur Bühnenplan“ oder „Mit Technik & Kanälen“; Darstellung und einzelne Inhalte bleiben anpassbar. Die vergrößerbare Vorschau zeigt dieselben A4-Querformatseiten wie der Ausdruck, mit Projekt-ID, Seitenzahlen, lesbaren Kanaltabellen, wiederholten Tabellenköpfen und vollständigen Notizen. Maßlinien folgen den Bühnenkanten und vermeiden Überlagerungen mit Anbauten. Kompakte Anforderungen, Kontakte, Equipment und Notizen nutzen automatisch Platz rechts, beidseitig oder unter dem Plan; lange Inhalte bleiben vollständig auf Folgeseiten. Auch PNGs platzieren technische Angaben je nach Bühnenform daneben oder darunter. Standard-/4K-PNG mit weißem oder transparentem Hintergrund sowie schreibgeschützte Freigabelinks bleiben verfügbar. Eine schwarze Bühne lässt sich für den Ausdruck unabhängig vom gespeicherten Projekt einstellen. Veranstalter-PDF und Projektkopien stehen mit der kostenlosen Pro-Beta bereit.
...
- **Gemeinsamer Audio-Plan:** Verwendete Signale sind die gemeinsame Grundlage für Bühnenobjekte, Input-/Outputlisten, Stagebox-Ports und PDFs. Derselbe Signal-Editor öffnet sich am Objekt, in der Liste und an einem belegten Stagebox-Port. Direkte Bereiche für Abnahme, Signalweg, Kanäle sowie Notizen & Funk halten den Dialog übersichtlich. Instrument, Kanalnummer und aktuelle Zuordnung bleiben sichtbar. Hersteller-Tasten und Modellkarten ersetzen das Mikrofon-Suchfeld; acht Original-Herstellerfotos sind lokal enthalten. Gerätebuchsen sind getrennte Kapazitätsangaben; neue Keyboards starten mit Stereo L/R, zusätzliche Signale lassen sich gezielt aktivieren.
...
- **Schnell zuordnen:** Suche nach Signal, Kanalnummer, Mikrofon oder Stagebox sowie Filter „Ohne Nummer“ und „Ohne Zuordnung“. Direkt an der Signalzeile öffnet „Stagebox verbinden“ ein kleines Fenster mit Stagebox-Bildern und einem Vorschlag für freie Buchsen. Die vollständige Stagebox-Belegung bleibt eine eigene Übersicht. Stereo wird gemeinsam zugeordnet; vorhandene Kanalnummern und Ports bleiben beim automatischen Ergänzen erhalten. Rückgängig/Wiederholen ist in allen Audio-Ansichten erreichbar.
