...
for(const marker of ['sp-audio-iem-fields','sp-audio-format','data-channel-value="stereo"','data-channel-value="wireless"','function saveAudioChannel(','data-route-phantom','function renumberRoutingRows(','data-outs-connector="MADI"','data-outs-connector="Dante"'])assert.ok(html.includes(marker),marker+' fehlt im neuen Routing-Workflow.');
