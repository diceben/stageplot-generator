...
function createStageplotPercussionModel() {
  ...
  function imageMarkup(p,unit=100) {
    ...
    if(p.type==='vocal-boom')return '<svg x="'+(-width/2)+'" y="'+(-height/2)+'" width="'+width+'" height="'+height+'" viewBox="0 0 65 90"><g fill="none" stroke="#444" stroke-width="2" stroke-linecap="round"><path d="M32 52L5 83M32 52L59 83M32 52V27" stroke="#888"/><circle cx="32" cy="52" r="3" fill="#999"/><path d="M32 52L44 12" stroke-width="3"/><path d="M43 15L49 2" stroke-width="6"/></g></svg>';
