...
In der Bausteinbibliothek unter **Ton & Monitoring → DI-Box** öffnen sich die sieben Untermodelle wie bei den Gitarren. Das Modell vor dem Platzieren auswählen. Einzelne Modelle können über die Suche gefunden und als Favoriten gespeichert werden. Die Eigenschaften zeigen die ausgewählte Box und ihre Eingänge; **Modell ändern** öffnet die gemeinsame Auswahl.
