...
const checks=['check-inspector-controls.cjs','check-object-menu-motion.cjs','check-stagebox-models.cjs','check-routing-workspace-v2.cjs','check-project-dashboard.cjs','check-mobile-library.cjs','check-mobile-routing.cjs','check-project-actions.cjs','check-share-navigation.cjs','check-project-sharing.cjs','check-venue-editor.cjs','check-stairs.cjs','check-mic-head-direction.cjs','check-mic-layers.cjs','check-mobile-stage.cjs','check-new-project.cjs','check-theme-switch.cjs','check-print-assets.cjs'];
