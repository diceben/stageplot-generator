...
const checks=['check-project-dashboard.cjs','check-mobile-library.cjs','check-mobile-routing.cjs','check-project-actions.cjs','check-venue-editor.cjs','check-mic-head-direction.cjs','check-mic-layers.cjs'];
