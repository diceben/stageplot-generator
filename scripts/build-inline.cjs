...
const MODULES = [
  ...
  { file: 'stageplot-playback-v1.js', transform: (s) => s.trim() },
  { file: 'stageplot-playback-v1.css', transform: (s) => s.trim() },
  { file: 'stageplot-audio-v1.css', transform: (s) => s.trim() },
  { file: 'stageplot-print-v1.js', transform: (s) => s.trim() },
  { file: 'stageplot-print-v1.css', transform: (s) => s.trim() },
  ...
  { file: 'stageplot-look-v1.js', transform: (s) => s.trim() },
