...
assert.match(html,/drumButton\.hidden=hidden\|\|!o\|\|\(!drumModel\.isDrums\(o\.type\)&&o\.type!=='percussion'\)/,'Der Schnellzugriff wird nicht auf ausgewählte Drum- und Percussion-Sets begrenzt.');
