...
assert.ok(html.includes("o.type==='rack'?'IEM-Monitore bearbeiten'")&&html.includes("o.type==='percussion'?'Drums & Percussion bearbeiten'"),'Das Objektmenü behält die speziellen Editoren.');
