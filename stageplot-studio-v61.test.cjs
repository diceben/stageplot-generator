...
assert.match(html,/drumButton\.hidden=hidden\|\|!o\|\|\(!drumModel\.isDrums\(o\.type\)&&!\['percussion','orchestra','laptop'\]\.includes\(o\.type\)\)/,'Der Schnellzugriff wird nicht auf ausgewählte Drum-, Percussion-, Orchester- und Playback-Objekte begrenzt.');
