...
for(const asset of ['stageplot-assets/branding/stageplotter-icon.png','stageplot-assets/branding/stageplotter-logo-transparent-v2.png','stageplot-assets/branding/stageplotter-header-pro-v3.png'])assert.ok(fs.existsSync(asset),asset+' fehlt.');
...
for(const marker of ['class="sp-brand-logo" id="sp-brand-logo" src="./stageplot-assets/branding/stageplotter-header-pro-v3.png"','class="sp-dashboard-logo" src="./stageplot-assets/branding/stageplotter-logo-transparent-v2.png"','id="sp-brand-fallback" hidden','syncBrandFallback'])assert.ok(html.includes(marker),marker+' fehlt im Markenauftritt.');
