...
assert.match(html,/drumButton\.hidden=hidden\|\|!o\|\|\(!drumModel\.isDrums\(o\.type\)&&!\['percussion','orchestra'\]\.includes\(o\.type\)\)/,'Der Schnellzugriff wird nicht auf ausgewählte Drum-, Percussion- und Orchester-Sets begrenzt.');
