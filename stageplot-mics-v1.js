...
const StageplotMics=(()=>{
  ...
  const drumTypicalMics={
    ...
    rackTom:['Generisches Drum-Mikrofon','Sennheiser MD 421','Sennheiser MD 421 Kompakt','Sennheiser e 604','Sennheiser e 904','Audix D2','Shure SM57','Shure Beta 56A','Shure Beta 98AMP/C','Audio-Technica ATM230','AKG D40','Telefunken M81-SH','Electro-Voice ND44','sE Electronics V BEAT','LEWITT DTP 340 TT','Earthworks DM20','beyerdynamic M 201'],
    floorTom:['Generisches Drum-Mikrofon','Audix D4','Sennheiser MD 421','Sennheiser MD 421 Kompakt','Sennheiser e 904','Sennheiser e 604','Shure SM57','beyerdynamic M 88','Electro-Voice RE20','Shure Beta 56A','Audio-Technica ATM230','AKG D40','Telefunken M81-SH','sE Electronics V BEAT','LEWITT DTP 340 TT','Earthworks DM20','DPA 4099 CORE'],
...
function suggestions(name){
  ...
  if(/guitar|gitarre|amp|cabinet|brass|sax|tromp/.test(text))return ['Shure SM57','Sennheiser MD 421 Kompakt','Sennheiser MD 421 II','beyerdynamic M 201','Audix i5'];
