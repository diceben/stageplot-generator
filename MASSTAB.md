...
## Bewusste Ausnahme: Boom-Mikrofone (11. September 2026)

Auf Nutzerwunsch wird der Mikrofonkopf am Boom zur besseren Erkennung größer dargestellt: 230 mm Bildlänge statt der bisherigen etwa 165 mm. Das ist eine Darstellungshilfe, kein reales Mikrofonmaß. Der Fußkreis bleibt 600 mm groß (bisheriger 650-mm-Rahmen einschließlich Rand). Der ausgezogene Boom ist auf 745 mm Gesamtlänge kalibriert; der 1450-mm-Schwenkrahmen umfasst den Arm samt Mikrofon in allen drei Richtungen. Bestehende eigene Stativmaße werden einmalig in den neuen Rahmen umgerechnet, damit der Fuß nicht kleiner wird. Extremwerte bleiben innerhalb der bisherigen 30 × 20-m-Grenze. Arm und Mikrofon sind separate, neu generierte monochrome Draufsicht-Assets; die Halterung lässt den Kopf beim Schwenken des Arms links/rechts nach oben zeigen. Die Gesamtdrehung des Bühnenobjekts bleibt wie bisher möglich. Die Original-Herstellerfotos der Mikrofonwahl bleiben unverändert.

Konstruktionsreferenzen: [K&M 210/9](https://www.k-m.de/en/products/microphone-stands/floor-stands/microphone-stands-with-boom/210-9-microphone-stand-black), [SM58 mit Halterung und Boom-Stativ](https://www.bhphotovideo.com/c/product/1378588-REG/shure_sm58_cn_vocal_mic_kit.html/specs). Neue Assets: [Boom-Arm](stageplot-assets/tech/mic-boom-arm-top-v3.webp), [Mikrofon mit Halterung](stageplot-assets/tech/mic-boom-head-top-v3.webp). Built-in-Bildgenerierung; vollständige Prompts unter den IDs `mic-boom` und `mic-boom-head` in [prompts.json](stageplot-assets/tech/prompts.json), Herkunft und Kalibrierung in [manifest.json](stageplot-assets/tech/manifest.json).

Browserprüfung der Boom-Korrektur: Chrome und WebKit, drei Richtungen, Umschalten und lokales Neuladen, 390-px-Handyansicht sowie PDF-/Bildvorschau auch offline. Optional reproduzierbar mit `scripts/check-boom-microphones.cjs`. Die Tests prüfen zusätzlich, dass der Mikrofonkopf unabhängig vom Arm bleibt und der Fußkreis erhalten wird.

Armreferenzen: [K&M 211/1, 435–745 mm](https://www.k-m.de/en/products/microphone-stands/boom-arms/211-1-boom-arm-black), [K&M 210/2, 800 mm](https://www.k-m.de/en/products/microphone-stands/floor-stands/microphone-stands-with-boom/210-2-microphone-stand-black?c=3598). Die Arme erscheinen einschließlich Rohrstärke im gleichen Maßstab wie der Fuß, ohne die frühere Verkleinerung auf einen 177,6-mm-Bildbereich.

Nachbesserung vom 12. September 2026: Die Einstellung „Boom-Arm oben“ zeigt den angehobenen Arm mit verkürzter Bodenprojektion (Faktor 0,34 entlang des Arms). Der Mikrofonkopf endet in der Draufsicht etwa 5 cm vor der vorderen sichtbaren Fußkante. Rohrstärke, Kopfgröße und Fuß bleiben erhalten; seitliche Arme werden weiterhin ausgezogen dargestellt. Der metrische Rahmen und bestehende Objektpositionen bleiben unverändert, der Auswahlrahmen folgt der sichtbaren Darstellung.
